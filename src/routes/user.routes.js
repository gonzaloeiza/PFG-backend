...
router.delete("/", middlewares.authMiddleware.verifyToken, middlewares.validationMiddleware.validationNoPendingBookingsToPay, middlewares.validationMiddleware.notPlayingAnyRanking, userController.deleteAccount);
